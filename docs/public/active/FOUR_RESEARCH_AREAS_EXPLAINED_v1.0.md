...
Status: ACTIVE  
Audience: Public  
Purpose: Methodology clarity & trust

---

## What “Informed by Professional Research” Means

When we say that the SoftFocus assessment is
**informed by established professional research**,
we mean that its structure, questions, and interpretation logic
are grounded in **well-documented ways professionals lose performance sustainability over time**.

We do not apply clinical diagnostics.
We apply **operational thinking**.

The assessment draws from four well-established research areas.

---

## 1. Occupational Burnout Research (Non-Clinical)

This body of research studies how **long-term work conditions**
...
Important boundary:
We do **not** use clinical diagnostic criteria
and do not assess mental health conditions.

---

## 2. Human Factors & Cognitive Load Research

Human factors research examines how people perform
in **complex, high-load environments** such as aviation,
...
This approach is standard in safety-critical industries.

---

## 3. Systems & Reliability Thinking

Systems and reliability research studies how failures
...
This is why the assessment avoids simple scores
and instead identifies dominant risk vectors.

---

## 4. Longitudinal Assessment Principles

Longitudinal assessment focuses on **change over time**
...
Individually, each research area explains part of the problem.
Together, they explain why:

- professionals often “feel fine” while degrading,
- burnout risk is missed until it becomes costly,
- recovery advice alone is insufficient,
- performance collapses appear sudden but are not.

SoftFocus integrates these perspectives
into a single, non-clinical assessment framework.
